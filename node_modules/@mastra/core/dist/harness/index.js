import { Mastra } from '../chunk-QGQ26M6C.js';
import { Agent } from '../chunk-DV4HM5AG.js';
import { Workspace, createWorkspaceTools } from '../chunk-UYMENNTN.js';
import { safeStringify } from '../chunk-OLA6JHDS.js';
import { createTool } from '../chunk-LWKMPCC7.js';
import { toStandardSchema } from '../chunk-6SRTDZ7S.js';
import { createSignal, mastraDBMessageToSignal } from '../chunk-JBIPWA5Y.js';
...
var Harness = class {
  ...
  async getCurrentModelAuthStatus() {
    ...
    try {
      const { PROVIDER_REGISTRY } = await import('../provider-registry-DGWW6Q2O.js');
...
export { Harness, askUserTool, assignTaskIds, defaultDisplayState, defaultOMProgressState, parseSubagentMeta, submitPlanTool, taskCheckTool, taskCompleteTool, taskUpdateTool, taskWriteTool };
