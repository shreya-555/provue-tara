...
- [Code mode](references/docs-agents-code-mode.md) - Let an agent write and run a single TypeScript program that orchestrates your tools, instead of calling tools one at a time.
...
- [Response Caching](references/docs-agents-response-caching.md) - Cache identical agent calls to skip the LLM, return responses instantly, and avoid duplicate spend.
