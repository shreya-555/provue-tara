...
var ScorerDefinitionsStorage = class extends chunkZKUOABDW_cjs.VersionedStorageDomain {
...
var InMemoryScorerDefinitionsStorage = class extends ScorerDefinitionsStorage {
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      scorers = scorers.filter((scorer) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkNLACGSDP_cjs.deepEqual(scorer.metadata[key], value));
      });
    }
  ...
  async listVersions(input) {
    ...
    const perPage = chunkZKUOABDW_cjs.normalizePerPage(perPageInput, 20);
    if (page < 0) {
      throw new Error("page must be >= 0");
    }
    const maxOffset = Number.MAX_SAFE_INTEGER / 2;
...
var FilesystemScorerDefinitionsStorage = class extends ScorerDefinitionsStorage {
  ...
  constructor({ db }) {
    super();
    this.helpers = new chunkZKUOABDW_cjs.FilesystemVersionedHelpers({
      db,
...
//# sourceMappingURL=chunk-Y3FHTZVR.cjs.map
//# sourceMappingURL=chunk-Y3FHTZVR.cjs.map