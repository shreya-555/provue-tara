...
function resolveConnectionAuthorId(connection, callerAuthorId, requestContext, logger) {
  ...
  if (connection.scope === "caller-supplied") {
    const resourceId = requestContext?.[chunk64VGLWFD_cjs.MASTRA_RESOURCE_ID_KEY];
