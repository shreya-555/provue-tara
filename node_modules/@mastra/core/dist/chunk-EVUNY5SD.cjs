...
var chunkWGC7CIWU_cjs = require('./chunk-WGC7CIWU.cjs');
var chunkFR5MABII_cjs = require('./chunk-FR5MABII.cjs');
var chunkX63DZHAT_cjs = require('./chunk-X63DZHAT.cjs');
var chunkY3FHTZVR_cjs = require('./chunk-Y3FHTZVR.cjs');
var chunkICOA5RYZ_cjs = require('./chunk-ICOA5RYZ.cjs');
var chunk2II3FADI_cjs = require('./chunk-2II3FADI.cjs');
var chunkOV43YUC7_cjs = require('./chunk-OV43YUC7.cjs');
var chunkZKUOABDW_cjs = require('./chunk-ZKUOABDW.cjs');
var chunk4BWZVLIE_cjs = require('./chunk-4BWZVLIE.cjs');
var chunkWZHQJ2FB_cjs = require('./chunk-WZHQJ2FB.cjs');
...
var ObservabilityStorage = class _ObservabilityStorage extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
      name: "OBSERVABILITY"
  ...
  async getBranch(args) {
    const parsed = chunkWZHQJ2FB_cjs.getBranchArgsSchema.parse(args);
    try {
      const skeleton = await this.getStructure({ traceId: parsed.traceId });
      if (!skeleton) return null;
      const branchSpanIds = chunkWZHQJ2FB_cjs.extractBranchSpans(skeleton.spans, parsed.spanId, parsed.depth).map((s) => s.spanId);
    ...
    const spans = chunkWZHQJ2FB_cjs.extractBranchSpans(trace.spans, parsed.spanId, parsed.depth);
...
function transformRow(row, tableName, options = {}) {
  ...
  const tableSchema = chunkWZHQJ2FB_cjs.TABLE_SCHEMAS[tableName];
  const result = {};
...
function transformScoreRow(row, options = {}) {
  return transformRow(row, chunkWZHQJ2FB_cjs.TABLE_SCORERS, options);
}
...
var ObservabilityInMemory = class extends ObservabilityStorage {
  ...
  maybeRegisterBranchCursor(span) {
    if (!chunkWZHQJ2FB_cjs.BRANCH_SPAN_TYPE_SET.has(span.spanType)) {
      return;
    }
  ...
  getMatchingRootSpans(args) {
    const { filters, pagination, orderBy } = chunkWZHQJ2FB_cjs.listTracesArgsSchema.parse(args);
  ...
  async listTraces(args) {
    const { mode, filters, after, limit } = chunkWZHQJ2FB_cjs.listTracesArgsSchema.parse(args);
    if (mode === "delta") {
      ...
      return {
        spans: chunkWZHQJ2FB_cjs.toTraceSpans(deltaResponse.rows),
    ...
    return {
      spans: chunkWZHQJ2FB_cjs.toTraceSpans(paged),
  ...
  async listBranches(args) {
    const { mode, filters, pagination, orderBy, after, limit } = chunkWZHQJ2FB_cjs.listBranchesArgsSchema.parse(args);
    if (mode === "delta") {
      this.assertDeltaPollingEnabled();
      ...
      return {
        branches: deltaResponse.rows.map(chunkWZHQJ2FB_cjs.toTraceSpan),
        delta: deltaResponse.delta,
        deltaCursor: deltaResponse.deltaCursor
      };
    }
    const allowedSpanTypes = filters?.spanType ? chunkWZHQJ2FB_cjs.BRANCH_SPAN_TYPE_SET.has(filters.spanType) ? /* @__PURE__ */ new Set([filters.spanType]) : /* @__PURE__ */ new Set() : chunkWZHQJ2FB_cjs.BRANCH_SPAN_TYPE_SET;
    const matches = [];
    for (const [, traceEntry] of this.db.traces) {
    ...
    return {
      ...
      branches: paged.map(chunkWZHQJ2FB_cjs.toTraceSpan),
  ...
  spanMatchesBranchFilters(span, filters) {
    ...
    if (filters.status !== void 0) {
      const spanStatus = chunkWZHQJ2FB_cjs.toTraceSpan(span).status;
  ...
  async listMetrics(args) {
    const { mode, filters, pagination, orderBy, after, limit } = chunkXDJV2I6J_cjs.listMetricsArgsSchema.parse(args);
    if (mode === "delta") {
      this.assertDeltaPollingEnabled();
  ...
  *iterateObservabilityContextRecords() {
  ...
  async getEntityTypes(_args) {
    const validTypes = new Set(Object.values(chunkXDJV2I6J_cjs.EntityType));
  ...
  async listLogs(args) {
    const { mode, filters, pagination, orderBy, after, limit } = chunkXDJV2I6J_cjs.listLogsArgsSchema.parse(args);
    if (mode === "delta") {
      this.assertDeltaPollingEnabled();
      const deltaResponse = this.listAppendOnlyDelta(
        this.db.logRecords,
  ...
  async listScores(args) {
    const { mode, filters, pagination, orderBy, after, limit } = chunkXDJV2I6J_cjs.listScoresArgsSchema.parse(args);
    if (mode === "delta") {
      this.assertDeltaPollingEnabled();
      const deltaResponse = this.listAppendOnlyDelta(
  ...
  async listFeedback(args) {
    const { mode, filters, pagination, orderBy, after, limit } = chunkXDJV2I6J_cjs.listFeedbackArgsSchema.parse(args);
    if (mode === "delta") {
      this.assertDeltaPollingEnabled();
      const deltaResponse = this.listAppendOnlyDelta(
...
var entityTypeValues = new Set(Object.values(chunkXDJV2I6J_cjs.EntityType));
...
var BackgroundTasksStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
...
var BlobStore = class extends chunkOXCC7WGI_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "BLOBS"
...
var ChannelsStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
      name: "CHANNELS"
...
var DatasetsStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
      name: "DATASETS"
...
var DatasetsInMemory = class extends DatasetsStorage {
  ...
  async listDatasets(args) {
    ...
    const perPage = chunkZKUOABDW_cjs.normalizePerPage(perPageInput, 100);
    const { offset: start, perPage: perPageForResponse } = chunkZKUOABDW_cjs.calculatePagination(page, perPageInput, perPage);
...
var ExperimentsStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
      name: "EXPERIMENTS"
...
var HarnessStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
      name: "HARNESS"
...
var MemoryStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  /**
...
var InMemoryMemory = class extends MemoryStorage {
  ...
  async listMessages({
    ...
    const perPage = chunkZKUOABDW_cjs.normalizePerPage(perPageInput, 40);
    if (page < 0) {
      throw new Error("page must be >= 0");
    }
    ...
    const { offset, perPage: perPageForResponse } = chunkZKUOABDW_cjs.calculatePagination(page, perPageInput, perPage);
  ...
  async listMessagesByResourceId({
    ...
    const list = new chunkDCCAHUCG_cjs.MessageList().add(
  ...
  async saveMessages(args) {
    ...
    const list = new chunkDCCAHUCG_cjs.MessageList().add(messages, "memory");
    return { messages: list.get.all.db() };
  }
...
var SchedulesStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
      name: "SCHEDULES"
...
var ScoresStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
      name: "SCORES"
...
var ScoresInMemory = class extends ScoresStorage {
  ...
  async listScoresByScorerId({
    ...
    const perPage = chunkZKUOABDW_cjs.normalizePerPage(perPageInput, Number.MAX_SAFE_INTEGER);
    const { offset: start, perPage: perPageForResponse } = chunkZKUOABDW_cjs.calculatePagination(page, perPageInput, perPage);
...
var ToolProviderConnectionsStorage = class extends chunkOXCC7WGI_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
...
var WorkflowsStorage = class extends chunkZKUOABDW_cjs.StorageDomain {
  constructor() {
    super({
      component: "STORAGE",
      name: "WORKFLOWS"
...
var WorkflowsInMemory = class extends WorkflowsStorage {
  ...
  async listWorkflowRuns({
    ...
    if (perPage !== void 0 && page !== void 0) {
      const normalizedPerPage = chunkZKUOABDW_cjs.normalizePerPage(perPage, Number.MAX_SAFE_INTEGER);
...
// src/storage/mock.ts
var InMemoryStore = class extends chunkZKUOABDW_cjs.MastraCompositeStore {
  stores;
  /**
  ...
  constructor({ id = "in-memory" } = {}) {
    ...
    this.stores = {
      ...
      agents: new chunkOV43YUC7_cjs.InMemoryAgentsStorage({ db: this.#db }),
      ...
      promptBlocks: new chunkX63DZHAT_cjs.InMemoryPromptBlocksStorage({ db: this.#db }),
      scorerDefinitions: new chunkY3FHTZVR_cjs.InMemoryScorerDefinitionsStorage({ db: this.#db }),
      mcpClients: new chunkWGC7CIWU_cjs.InMemoryMCPClientsStorage({ db: this.#db }),
      mcpServers: new chunkFR5MABII_cjs.InMemoryMCPServersStorage({ db: this.#db }),
      workspaces: new chunk2II3FADI_cjs.InMemoryWorkspacesStorage({ db: this.#db }),
      skills: new chunkICOA5RYZ_cjs.InMemorySkillsStorage({ db: this.#db }),
      favorites: new chunk4BWZVLIE_cjs.InMemoryFavoritesStorage({ db: this.#db }),
...
var FilesystemStore = class extends chunkZKUOABDW_cjs.MastraCompositeStore {
  #db;
  #dir;
  constructor(config = {}) {
    ...
    this.stores = {
      agents: new chunkOV43YUC7_cjs.FilesystemAgentsStorage({ db: this.#db }),
      promptBlocks: new chunkX63DZHAT_cjs.FilesystemPromptBlocksStorage({ db: this.#db }),
      scorerDefinitions: new chunkY3FHTZVR_cjs.FilesystemScorerDefinitionsStorage({ db: this.#db }),
      mcpClients: new chunkWGC7CIWU_cjs.FilesystemMCPClientsStorage({ db: this.#db }),
      mcpServers: new chunkFR5MABII_cjs.FilesystemMCPServersStorage({ db: this.#db }),
      workspaces: new chunk2II3FADI_cjs.FilesystemWorkspacesStorage({ db: this.#db }),
      skills: new chunkICOA5RYZ_cjs.FilesystemSkillsStorage({ db: this.#db })
    };
  }
  /**
...
var StoreOperations = class extends chunkOXCC7WGI_cjs.MastraBase {
  constructor() {
    super({
      component: "STORAGE",
      name: "OPERATIONS"
...
var StoreOperationsInMemory = class extends StoreOperations {
  ...
  async insert({ tableName, record }) {
    ...
    let key = record.id;
    if ([chunkWZHQJ2FB_cjs.TABLE_WORKFLOW_SNAPSHOT].includes(tableName) && !record.id && record.run_id) {
...
//# sourceMappingURL=chunk-EVUNY5SD.cjs.map
//# sourceMappingURL=chunk-EVUNY5SD.cjs.map