import { NetlifyGateway } from './chunk-EGOXC4P3.js';
import { ModelsDevGateway, createOpenRouter } from './chunk-BUYYRTKQ.js';
import { MastraModelGateway, createAnthropic, MASTRA_USER_AGENT, GATEWAY_AUTH_HEADER } from './chunk-MYOPAZ5K.js';
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-CMMTPHAZ.js');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-CODWZ7IG.js');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-ZKR6U5YM.js');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-74I3CDJ7.js');
...
export { GatewayRegistry, MastraGateway, PROVIDER_MODELS, PROVIDER_REGISTRY, getProviderConfig, getRegisteredProviders, isOfflineMode, isProviderRegistered, isValidModelId, modelSupportsAttachments, parseModelString };
//# sourceMappingURL=chunk-6KS7BBA5.js.map
//# sourceMappingURL=chunk-6KS7BBA5.js.map