...
// src/server/auth.ts
var MastraAuthProvider = class extends chunkOXCC7WGI_cjs.MastraBase {
  protected;
  public;
  constructor(options) {
...
// src/server/base.ts
var MastraServerBase = class extends chunkOXCC7WGI_cjs.MastraBase {
  #app;
  constructor({ app, name }) {
    super({ component: chunk4CVPHNP6_cjs.RegisteredLogger.SERVER, name: name ?? "Server" });
    this.#app = app;
  }
  /**
...
function validateOptions(path, options) {
  if (options.method === void 0) {
    throw new chunkXSOONORA_cjs.MastraError({
      ...
      domain: chunkXSOONORA_cjs.ErrorDomain.MASTRA_SERVER,
