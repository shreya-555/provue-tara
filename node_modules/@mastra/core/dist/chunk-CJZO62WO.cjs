...
var NetlifyGateway = class extends chunkJBYS3POB_cjs.MastraModelGateway {
  id = "netlify";
  ...
  async resolveLanguageModel({
    ...
    const mastraHeaders = { "User-Agent": chunkJBYS3POB_cjs.MASTRA_USER_AGENT, ...headers };
    switch (providerId) {
      case "openai":
        return chunkJBYS3POB_cjs.createOpenAI({ apiKey, baseURL, headers: mastraHeaders }).responses(modelId);
      case "gemini":
        return chunkJBYS3POB_cjs.createGoogleGenerativeAI({
      ...
      default:
        return chunkJBYS3POB_cjs.createOpenAICompatible({
          name: providerId,
          apiKey,
          baseURL,
...
//# sourceMappingURL=chunk-CJZO62WO.cjs.map
//# sourceMappingURL=chunk-CJZO62WO.cjs.map