...
function createStepFromProcessor(processor) {
  ...
  return {
    ...
    execute: async ({ inputData, requestContext, outputWriter, ...obsFields }) => {
      ...
      const processorMessageList = messageList ?? (Array.isArray(messages) ? new MessageList().add(messages, "input").addSystem(systemMessages ?? []) : void 0);
      const baseContext = {
        abort,
...
export { EventedExecutionEngine, EventedRun, EventedWorkflow, StepExecutor, WorkflowEventProcessor, cloneStep, cloneWorkflow, computeNextFireAt, createStep, createWorkflow, getStep, validateCron };
//# sourceMappingURL=chunk-EZZHFUSL.js.map
//# sourceMappingURL=chunk-EZZHFUSL.js.map