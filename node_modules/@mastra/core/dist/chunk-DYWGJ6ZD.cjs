...
var chunkXKOQ7YF6_cjs = require('./chunk-XKOQ7YF6.cjs');
var chunkCJZO62WO_cjs = require('./chunk-CJZO62WO.cjs');
var chunk7WVQHAW5_cjs = require('./chunk-7WVQHAW5.cjs');
var chunkJBYS3POB_cjs = require('./chunk-JBYS3POB.cjs');
var chunkREDVAZH5_cjs = require('./chunk-REDVAZH5.cjs');
var chunkZLNWRIBN_cjs = require('./chunk-ZLNWRIBN.cjs');
...
var AISDKV6LanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    return {
      ...
      stream: chunkREDVAZH5_cjs.createStreamFromGenerateResult(result)
    };
  }
...
var openaiFailedResponseHandler = chunkJBYS3POB_cjs.createJsonErrorResponseHandler({
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    type: "image_url",
                    image_url: {
                      url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkJBYS3POB_cjs.convertToBase64(part.data)}`,
                  ...
                  if (part.data instanceof URL) {
                    throw new chunkJBYS3POB_cjs.UnsupportedFunctionalityError({
                  ...
                  switch (part.mediaType) {
                    case "audio/wav": {
                      return {
                        type: "input_audio",
                        input_audio: {
                          data: chunkJBYS3POB_cjs.convertToBase64(part.data),
                          format: "wav"
                        }
                      };
                    }
                  ...
                  return {
                    ...
                    file: typeof part.data === "string" && part.data.startsWith("file-") ? { file_id: part.data } : {
                      ...
                      file_data: `data:application/pdf;base64,${chunkJBYS3POB_cjs.convertToBase64(part.data)}`
                    }
                  };
                } else {
                  throw new chunkJBYS3POB_cjs.UnsupportedFunctionalityError({
...
var openaiChatResponseSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var openaiChatChunkSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiChatLanguageModelOptions = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAIChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a, _b, _c, _d;
    const warnings = [];
    const openaiOptions = (_a = await chunkJBYS3POB_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
  ...
  async doGenerate(options) {
    ...
    } = await chunkJBYS3POB_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunkJBYS3POB_cjs.combineHeaders(this.config.headers(), options.headers),
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkJBYS3POB_cjs.createJsonResponseHandler(
    ...
    for (const toolCall of (_a = choice.message.tool_calls) != null ? _a : []) {
      content.push({
        type: "tool-call",
        toolCallId: (_b = toolCall.id) != null ? _b : chunkJBYS3POB_cjs.generateId(),
    ...
    for (const annotation of (_c = choice.message.annotations) != null ? _c : []) {
      content.push({
        type: "source",
        sourceType: "url",
        id: chunkJBYS3POB_cjs.generateId(),
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkJBYS3POB_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkJBYS3POB_cjs.createEventSourceResponseHandler(
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.type != null && toolCallDelta.type !== "function") {
                    throw new chunkJBYS3POB_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                  ...
                  if (((_o = toolCall2.function) == null ? void 0 : _o.name) != null && ((_p = toolCall2.function) == null ? void 0 : _p.arguments) != null) {
                    ...
                    if (chunkJBYS3POB_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_q = toolCall2.id) != null ? _q : chunkJBYS3POB_cjs.generateId(),
                ...
                if (((_v = toolCall.function) == null ? void 0 : _v.name) != null && ((_w = toolCall.function) == null ? void 0 : _w.arguments) != null && chunkJBYS3POB_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_x = toolCall.id) != null ? _x : chunkJBYS3POB_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
...
`;
  ...
  for (const { role, content } of prompt) {
    switch (role) {
      case "system": {
        throw new chunkJBYS3POB_cjs.InvalidPromptError({
...
var openaiCompletionResponseSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiCompletionChunkSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiCompletionProviderOptions = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAICompletionLanguageModel = class {
  ...
  async getArgs({
    ...
    const warnings = [];
    const openaiOptions = {
      ...await chunkJBYS3POB_cjs.parseProviderOptions({
        provider: "openai",
        providerOptions,
...
var openaiEmbeddingProviderOptions = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
...
var openaiTextEmbeddingResponseSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var OpenAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkJBYS3POB_cjs.TooManyEmbeddingValuesForCallError({
        provider: this.provider,
        modelId: this.modelId,
    ...
    const {
      ...
      headers: chunkJBYS3POB_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        model: this.modelId,
        input: values,
...
var openaiImageResponseSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      created: v4.z.number().nullish(),
      data: v4.z.array(
...
chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(baseImageModelOptionsObject)
);
var openaiImageModelGenerationOptions = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
...
var OpenAIImageModel = class {
  ...
  async doGenerate({
    ...
    const openaiOptions = (_d = await chunkJBYS3POB_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
      schema: openaiImageModelGenerationOptions
    })) != null ? _d : {};
    const { value: response, responseHeaders } = await chunkJBYS3POB_cjs.postJsonToApi({
      url: this.config.url({
...
var openaiTranscriptionResponseSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      text: v4.z.string(),
...
var openAITranscriptionProviderOptions = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
...
var OpenAITranscriptionModel = class {
  ...
  async getArgs({
    ...
    const warnings = [];
    const openAIOptions = await chunkJBYS3POB_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
      schema: openAITranscriptionProviderOptions
    });
    const formData = new FormData();
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkJBYS3POB_cjs.convertBase64ToUint8Array(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunkJBYS3POB_cjs.mediaTypeToExtension(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkJBYS3POB_cjs.postFormDataToApi({
      url: this.config.url({
...
var openaiSpeechProviderOptionsSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var OpenAISpeechModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: requestBody,
      failedResponseHandler: openaiFailedResponseHandler,
      successfulResponseHandler: chunkJBYS3POB_cjs.createBinaryResponseHandler(),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    return {
...
var localShellInputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      action: v4.z.object({
...
var localShellOutputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(v4.z.object({ output: v4.z.string() }))
);
chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
                ...
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    ...
                    ...part.data instanceof URL ? { image_url: part.data.toString() } : typeof part.data === "string" && isFileId(part.data, fileIdPrefixes) ? { file_id: part.data } : {
                      image_url: `data:${mediaType};base64,${chunkJBYS3POB_cjs.convertToBase64(part.data)}`
                    },
          ...
          switch (part.type) {
            ...
            case "tool-call": {
              ...
              if (hasLocalShellTool && part.toolName === "local_shell") {
                const parsedInput = await chunkJBYS3POB_cjs.validateTypes({
                  value: part.input,
            ...
            case "reasoning": {
              const providerOptions = await chunkJBYS3POB_cjs.parseProviderOptions({
                provider: "openai",
      ...
      case "tool": {
        for (const part of content) {
          ...
          if (hasLocalShellTool && part.toolName === "local_shell" && output.type === "json") {
            const parsedOutput = await chunkJBYS3POB_cjs.validateTypes({
              value: output.value,
...
var openaiResponsesChunkSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
...
var openaiResponsesResponseSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var openaiResponsesProviderOptionsSchema = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterInputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterOutputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      outputs: v4.z.array(
        v4.z.discriminatedUnion("type", [
...
var codeInterpreterArgsSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var codeInterpreterToolFactory = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var fileSearchArgsSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var fileSearchOutputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      queries: v4.z.array(v4.z.string()),
      results: v4.z.array(
...
var fileSearch = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.file_search",
  name: "file_search",
  inputSchema: v4.z.object({}),
  outputSchema: fileSearchOutputSchema
});
var webSearchArgsSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var webSearchInputSchema = chunkJBYS3POB_cjs.lazySchema(() => chunkJBYS3POB_cjs.zodSchema(v4.z.object({})));
var webSearchOutputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreviewArgsSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      searchContextSize: v4.z.enum(["low", "medium", "high"]).optional(),
      userLocation: v4.z.object({
...
var webSearchPreviewInputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(v4.z.object({}))
);
var webSearchPreviewOutputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreview = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.web_search_preview",
  name: "web_search_preview",
  inputSchema: webSearchPreviewInputSchema,
  outputSchema: webSearchPreviewOutputSchema
});
var imageGenerationArgsSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var imageGenerationInputSchema = chunkJBYS3POB_cjs.lazySchema(() => chunkJBYS3POB_cjs.zodSchema(v4.z.object({})));
var imageGenerationOutputSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(v4.z.object({ result: v4.z.string() }))
);
var imageGenerationToolFactory = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
      ...
      case "provider-defined": {
        switch (tool.id) {
          case "openai.file_search": {
            const args = await chunkJBYS3POB_cjs.validateTypes({
              value: tool.args,
...
var OpenAIResponsesLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error) {
      throw new chunkJBYS3POB_cjs.APICallError({
            ...
            for (const annotation of contentPart.annotations) {
              if (annotation.type === "url_citation") {
                content.push({
                  type: "source",
                  sourceType: "url",
                  id: (_f = (_e = (_d = this.config).generateId) == null ? void 0 : _e.call(_d)) != null ? _f : chunkJBYS3POB_cjs.generateId(),
                  url: annotation.url,
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_i = (_h = (_g = this.config).generateId) == null ? void 0 : _h.call(_g)) != null ? _i : chunkJBYS3POB_cjs.generateId(),
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_o = (_n = (_m = this.config).generateId) == null ? void 0 : _n.call(_m)) != null ? _o : chunkJBYS3POB_cjs.generateId(),
                  mediaType: "text/plain",
                ...
                content.push({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = this.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunkJBYS3POB_cjs.generateId(),
            ...
            if (isResponseOutputItemAddedChunk(value)) {
              ...
              if (value.annotation.type === "url_citation") {
                controller.enqueue({
                  type: "source",
                  sourceType: "url",
                  id: (_r = (_q = (_p = self.config).generateId) == null ? void 0 : _q.call(_p)) != null ? _r : chunkJBYS3POB_cjs.generateId(),
                ...
                controller.enqueue({
                  type: "source",
                  sourceType: "document",
                  id: (_u = (_t = (_s = self.config).generateId) == null ? void 0 : _t.call(_s)) != null ? _u : chunkJBYS3POB_cjs.generateId(),
                  mediaType: "text/plain",
...
// ../../../../../setup-pnpm/node_modules/.bin/store/v11/links/@ai-sdk/azure/2.0.108/cc42d7301d89387edfff66a32c1167f863448726cc77307409b1893f30947431/node_modules/@ai-sdk/azure/dist/index.mjs
...
function createAzure(options = {}) {
  ...
  const getHeaders = () => {
    const baseHeaders = {
      "api-key": chunkJBYS3POB_cjs.loadApiKey({
    ...
    return chunkJBYS3POB_cjs.withUserAgentSuffix(baseHeaders, `ai-sdk/azure/${VERSION}`);
  };
  const getResourceName = () => chunkJBYS3POB_cjs.loadSetting({
...
function mirrorAzureProviderOptionsForOpenAI(providerOptions) {
  ...
  const openai2 = isRecord(providerOptions.openai) ? providerOptions.openai : {};
  return {
    ...providerOptions,
    openai: {
      ...openai2,
...
var AzureOpenAIGateway = class extends chunkJBYS3POB_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
    this.validateConfig();
  ...
  id = "azure-openai";
  name = "azure-openai";
  tokenCache = new chunkZLNWRIBN_cjs.InMemoryServerCache();
  ...
  async resolveLanguageModel({
    ...
    const azureConfig = {
      ...
      headers: { "User-Agent": chunkJBYS3POB_cjs.MASTRA_USER_AGENT, ...headers },
    ...
    if (useResponsesAPI) {
      ...
      if (websocketFetch) {
        Object.defineProperty(model, chunkJBYS3POB_cjs.MASTRA_GATEWAY_STREAM_TRANSPORT, {
          configurable: true,
          value: {
...
function getStaticProvidersByGateway(name) {
  return Object.fromEntries(Object.entries(chunkXKOQ7YF6_cjs.PROVIDER_REGISTRY).filter(([_provider, config]) => config.gateway === name));
}
var defaultGateways = [
  new chunkCJZO62WO_cjs.NetlifyGateway(),
  new chunkXKOQ7YF6_cjs.MastraGateway(),
  new chunk7WVQHAW5_cjs.ModelsDevGateway(getStaticProvidersByGateway(`models.dev`))
];
var ModelRouterLanguageModel = class _ModelRouterLanguageModel {
  ...
  constructor(config, customGateways) {
    ...
    const parsed = chunk7WVQHAW5_cjs.parseModelRouterId(normalizedConfig.id, gatewayPrefix);
  ...
  async _fetchSupportedUrls() {
    ...
    try {
      ...
      const model = await this.resolveLanguageModel({
        ...
        ...chunk7WVQHAW5_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix)
      });
  ...
  async doGenerate(options) {
    ...
    const aiSDKV5Model = new chunkREDVAZH5_cjs.AISDKV5LanguageModel(model);
  ...
  async doStream(options) {
    ...
    const gatewayPrefix = this.gateway.id === "models.dev" ? void 0 : this.gateway.id;
    const parsedModelId = chunk7WVQHAW5_cjs.parseModelRouterId(this.config.routerId, gatewayPrefix);
    ...
    const allowWebSocket = requestedTransport === "websocket" && !this.config.url && (this.gateway.id === "models.dev" && OPENAI_WS_ALLOWLIST.has(this.provider) || this.gateway.id === "azure-openai");
  ...
  async resolveLanguageModel({
    ...
    const usesExplicitApiKey = this.config.apiKey !== void 0;
    ...
    if (this.config.url) {
      const modelInstance2 = chunkJBYS3POB_cjs.createOpenAICompatible({
        name: providerId,
        apiKey,
  ...
  resolveOpenAIWebSocketModel({
    ...
    const modelInstance = chunkJBYS3POB_cjs.createOpenAI({
      apiKey,
      baseURL,
      headers,
      fetch: wsFetch
...
function readGatewayStreamTransport(model) {
  return model[chunkJBYS3POB_cjs.MASTRA_GATEWAY_STREAM_TRANSPORT];
}
...
async function resolveModelConfig(modelConfig, requestContext = new chunk64VGLWFD_cjs.RequestContext(), mastra) {
  if (typeof modelConfig === "function") {
    modelConfig = await modelConfig({ requestContext, mastra });
  }
  if (modelConfig instanceof ModelRouterLanguageModel || modelConfig instanceof AISDKV4LegacyLanguageModel || modelConfig instanceof chunkREDVAZH5_cjs.AISDKV5LanguageModel || modelConfig instanceof AISDKV6LanguageModel) {
    return modelConfig;
  }
  if (typeof modelConfig === "object" && "specificationVersion" in modelConfig) {
    if (modelConfig.specificationVersion === "v2") {
      return new chunkREDVAZH5_cjs.AISDKV5LanguageModel(modelConfig);
    }
...
var VERSION2 = "2.0.72" ;
var googleErrorDataSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      error: v4.z.object({
...
var googleFailedResponseHandler = chunkJBYS3POB_cjs.createJsonErrorResponseHandler({
...
var googleGenerativeAIEmbeddingProviderOptions = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
...
var GoogleGenerativeAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const googleOptions = await chunkJBYS3POB_cjs.parseProviderOptions({
      provider: "google",
      providerOptions,
    ...
    const mergedHeaders = chunkJBYS3POB_cjs.combineHeaders(
      await chunkJBYS3POB_cjs.resolve(this.config.headers),
      headers
    );
...
var googleGenerativeAITextEmbeddingResponseSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var googleGenerativeAISingleEmbeddingResponseSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var googleGenerativeAIProviderOptions = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var GoogleGenerativeAILanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a = config.generateId) != null ? _a : chunkJBYS3POB_cjs.generateId;
  }
  get provider() {
    return this.config.provider;
  }
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkJBYS3POB_cjs.createJsonResponseHandler(responseSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
  ...
  async doStream(options) {
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const headers = chunkJBYS3POB_cjs.combineHeaders(
      await chunkJBYS3POB_cjs.resolve(this.config.headers),
      options.headers
    );
    const { responseHeaders, value: response } = await chunkJBYS3POB_cjs.postJsonToApi({
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkJBYS3POB_cjs.createEventSourceResponseHandler(chunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    let finishReason = "unknown";
...
var responseSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var chunkSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      candidates: v4.z.array(
        v4.z.object({
...
var codeExecution = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var enterpriseWebSearch = chunkJBYS3POB_cjs.createProviderDefinedToolFactory({
  id: "google.enterprise_web_search",
  name: "enterprise_web_search",
  inputSchema: chunkJBYS3POB_cjs.lazySchema(() => chunkJBYS3POB_cjs.zodSchema(v4.z.object({})))
});
...
var fileSearchArgsSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(fileSearchArgsBaseSchema)
);
var fileSearch2 = chunkJBYS3POB_cjs.createProviderDefinedToolFactory({
  id: "google.file_search",
  name: "file_search",
  inputSchema: fileSearchArgsSchema2
});
var googleMaps = chunkJBYS3POB_cjs.createProviderDefinedToolFactory({
...
var googleSearchToolArgsSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(googleSearchToolArgsBaseSchema)
);
var googleSearch = chunkJBYS3POB_cjs.createProviderDefinedToolFactory({
  id: "google.google_search",
  name: "google_search",
  inputSchema: googleSearchToolArgsSchema
});
var urlContext = chunkJBYS3POB_cjs.createProviderDefinedToolFactory({
  id: "google.url_context",
  name: "url_context",
  inputSchema: chunkJBYS3POB_cjs.lazySchema(() => chunkJBYS3POB_cjs.zodSchema(v4.z.object({})))
});
var vertexRagStore = chunkJBYS3POB_cjs.createProviderDefinedToolFactory({
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerate(options) {
    ...
    const { responseHeaders, value: response } = await chunkJBYS3POB_cjs.postJsonToApi({
      ...
      headers: chunkJBYS3POB_cjs.combineHeaders(await chunkJBYS3POB_cjs.resolve(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkJBYS3POB_cjs.createJsonResponseHandler(
...
var googleImageResponseSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
var googleImageProviderOptionsSchema = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
...
function createGoogleGenerativeAI(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunkJBYS3POB_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://generativelanguage.googleapis.com/v1beta";
  const providerName = (_b = options.name) != null ? _b : "google.generative-ai";
  const getHeaders = () => chunkJBYS3POB_cjs.withUserAgentSuffix(
    {
      "x-goog-api-key": chunkJBYS3POB_cjs.loadApiKey({
        apiKey: options.apiKey,
  ...
  const createChatModel = (modelId) => {
    ...
    return new GoogleGenerativeAILanguageModel(modelId, {
      ...
      baseURL,
      headers: getHeaders,
      generateId: (_a2 = options.generateId) != null ? _a2 : chunkJBYS3POB_cjs.generateId,
      supportedUrls: () => ({
        "*": [
...
var openaiFailedResponseHandler2 = chunkJBYS3POB_cjs.createJsonErrorResponseHandler({
...
var openaiChatResponseSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiChatChunkSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiChatLanguageModelOptions2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
       * Modify the likelihood of specified tokens appearing in the completion.
...
var openaiCompletionResponseSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().nullish(),
      created: v4.z.number().nullish(),
...
var openaiCompletionChunkSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
...
var openaiCompletionProviderOptions2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
      Echo back the prompt in addition to the completion.
...
var openaiEmbeddingProviderOptions2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
      The number of dimensions the resulting output embeddings should have.
...
var openaiTextEmbeddingResponseSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      data: v4.z.array(v4.z.object({ embedding: v4.z.array(v4.z.number()) })),
      usage: v4.z.object({ prompt_tokens: v4.z.number() }).nullish()
...
var openaiImageResponseSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      created: v4.z.number().nullish(),
      data: v4.z.array(
...
var baseImageModelOptionsObject2 = v4.z.object({
  /**
   * Quality of the generated image(s).
   *
   * Valid values: `standard`, `hd`, `low`, `medium`, `high`, `auto`.
...
chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(baseImageModelOptionsObject2)
);
var openaiImageModelGenerationOptions2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    baseImageModelOptionsObject2.extend({
      /**
       * Style of the generated image. `vivid` produces hyper-real and
       * dramatic images; `natural` produces more subdued, less hyper-real
       * looking images.
...
var OpenAIImageModel2 = class {
  ...
  async doGenerate({
    ...
    const openaiOptions = (_d = await chunkJBYS3POB_cjs.parseProviderOptions({
      provider: "openai",
      providerOptions,
      schema: openaiImageModelGenerationOptions2
    })) != null ? _d : {};
    const { value: response, responseHeaders } = await chunkJBYS3POB_cjs.postJsonToApi({
      url: this.config.url({
        path: "/images/generations",
...
var codeInterpreterInputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      code: v4.z.string().nullish(),
      containerId: v4.z.string()
...
var codeInterpreterOutputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      outputs: v4.z.array(
        v4.z.discriminatedUnion("type", [
...
var codeInterpreterArgsSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      container: v4.z.union([
        v4.z.string(),
...
var codeInterpreterToolFactory2 = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.code_interpreter",
  name: "code_interpreter",
...
var fileSearchArgsSchema3 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      vectorStoreIds: v4.z.array(v4.z.string()),
      maxNumResults: v4.z.number().optional(),
...
var fileSearchOutputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      queries: v4.z.array(v4.z.string()),
      results: v4.z.array(
...
var fileSearch3 = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.file_search",
  name: "file_search",
  inputSchema: v4.z.object({}),
  outputSchema: fileSearchOutputSchema2
});
var imageGenerationArgsSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      background: v4.z.enum(["auto", "opaque", "transparent"]).optional(),
      inputFidelity: v4.z.enum(["low", "high"]).optional(),
...
var imageGenerationInputSchema2 = chunkJBYS3POB_cjs.lazySchema(() => chunkJBYS3POB_cjs.zodSchema(v4.z.object({})));
var imageGenerationOutputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(v4.z.object({ result: v4.z.string() }))
);
var imageGenerationToolFactory2 = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.image_generation",
  name: "image_generation",
...
var localShellInputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      action: v4.z.object({
        type: v4.z.literal("exec"),
...
var localShellOutputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(v4.z.object({ output: v4.z.string() }))
);
var localShell2 = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.local_shell",
  name: "local_shell",
  inputSchema: localShellInputSchema2,
  outputSchema: localShellOutputSchema2
});
var webSearchArgsSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      externalWebAccess: v4.z.boolean().optional(),
      filters: v4.z.object({ allowedDomains: v4.z.array(v4.z.string()).optional() }).optional(),
...
var webSearchInputSchema2 = chunkJBYS3POB_cjs.lazySchema(() => chunkJBYS3POB_cjs.zodSchema(v4.z.object({})));
var webSearchOutputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchToolFactory2 = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.web_search",
  name: "web_search",
...
var webSearchPreviewArgsSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      searchContextSize: v4.z.enum(["low", "medium", "high"]).optional(),
      userLocation: v4.z.object({
...
var webSearchPreviewInputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(v4.z.object({}))
);
var webSearchPreviewOutputSchema2 = chunkJBYS3POB_cjs.lazySchema(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      action: v4.z.discriminatedUnion("type", [
        v4.z.object({
...
var webSearchPreview2 = chunkJBYS3POB_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "openai.web_search_preview",
  name: "web_search_preview",
...
var openaiResponsesChunkSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        type: v4.z.literal("response.output_text.delta"),
...
var openaiResponsesResponseSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      id: v4.z.string().optional(),
      created_at: v4.z.number().optional(),
...
var openaiResponsesProviderOptionsSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      conversation: v4.z.string().nullish(),
      include: v4.z.array(
...
var openaiSpeechProviderOptionsSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      instructions: v4.z.string().nullish(),
      speed: v4.z.number().min(0.25).max(4).default(1).nullish()
...
var openaiTranscriptionResponseSchema2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      text: v4.z.string(),
      language: v4.z.string().nullish(),
...
var openAITranscriptionProviderOptions2 = chunkJBYS3POB_cjs.lazyValidator(
  () => chunkJBYS3POB_cjs.zodSchema(
    v4.z.object({
      /**
       * Additional information to include in the transcription response.
...
var VERSION3 = "2.0.106" ;
function createOpenAI2(options = {}) {
  var _a, _b;
  const baseURL = (_a = chunkJBYS3POB_cjs.withoutTrailingSlash(
    chunkJBYS3POB_cjs.loadOptionalSetting({
  ...
  const getHeaders = () => chunkJBYS3POB_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkJBYS3POB_cjs.loadApiKey({
        apiKey: options.apiKey,
...
var ModelRouterEmbeddingModel = class {
  ...
  constructor(config) {
    ...
    if (normalizedConfig.url) {
      ...
      this.providerModel = chunkJBYS3POB_cjs.createOpenAICompatible({
      ...
      const registry = chunkXKOQ7YF6_cjs.GatewayRegistry.getInstance();
...
//# sourceMappingURL=chunk-DYWGJ6ZD.cjs.map
//# sourceMappingURL=chunk-DYWGJ6ZD.cjs.map