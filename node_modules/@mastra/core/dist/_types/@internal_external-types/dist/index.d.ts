...
import { JSONSchema7 as JSONSchema7_2 } from '../../@ai-sdk_provider/dist/index.d.ts';
import { JSONValue } from '../../@ai-sdk_provider/dist/index.d.ts';
import { LanguageModelV1ProviderMetadata } from '../../@ai-sdk_provider/dist/index.d.ts';
import { LanguageModelV2ToolResultOutput } from '../../@ai-sdk_provider/dist/index.d.ts';
import { LanguageModelV2ToolResultPart } from '../../@ai-sdk_provider/dist/index.d.ts';
import { SharedV2ProviderOptions } from '../../@ai-sdk_provider/dist/index.d.ts';
import { z } from 'zod';
...
declare type Schema_2<OBJECT = unknown> = Validator<OBJECT> & {
     ...
     * The JSON Schema for the schema. It is passed to the providers.
     */
    readonly jsonSchema: JSONSchema7_2;
};
