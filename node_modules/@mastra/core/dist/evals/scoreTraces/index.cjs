...
var getTraceStep = chunkSHMNNTFZ_cjs.createStep({
...
async function runScorerOnTarget({
  ...
  const result = await scorer.run({
    ...
    scoreSource: "trace",
    targetScope: "span",
    targetEntityType: chunkEDFBQDWJ_cjs.getEntityTypeForSpan(span),
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunkWZHQJ2FB_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkSHMNNTFZ_cjs.createWorkflow({
