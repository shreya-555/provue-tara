...
var unicodeNormalizerProvider = {
  ...
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.UnicodeNormalizer(config);
  }
};
var tokenLimiterProvider = {
  ...
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.TokenLimiterProcessor(
      config
    );
  }
};
var toolCallFilterProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.ToolCallFilter(config);
  }
};
var batchPartsProvider = {
  ...
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.BatchPartsProcessor(config);
  }
};
var moderationProvider = {
  ...
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.ModerationProcessor(config);
  }
};
var promptInjectionDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.PromptInjectionDetector(config);
  }
};
var piiDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.PIIDetector(config);
  }
};
var languageDetectorProvider = {
  ...
  availablePhases: ["processInput"],
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.LanguageDetector(config);
  }
};
var systemPromptScrubberProvider = {
  ...
  createProcessor(config) {
    return new chunkPPP5XYB5_cjs.SystemPromptScrubber(config);
  }
};
