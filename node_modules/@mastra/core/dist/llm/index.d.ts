import type { EmbedManyResult as AiEmbedManyResult, EmbedResult as AiEmbedResult, CoreAssistantMessage as AiCoreAssistantMessage, CoreMessage as AiCoreMessage, CoreSystemMessage as AiCoreSystemMessage, CoreToolMessage as AiCoreToolMessage, CoreUserMessage as AiCoreUserMessage, UIMessage, streamText, streamObject, generateText, generateObject, StreamTextOnFinishCallback, StreamObjectOnFinishCallback } from '../_types/@internal_ai-sdk-v4/dist/index.d.ts';
import type { SystemModelMessage } from '../_types/@internal_ai-sdk-v5/dist/index.d.ts';
...
export { GatewayRegistry, PROVIDER_REGISTRY, parseModelString, getProviderConfig, modelSupportsAttachments, } from './model/provider-registry.js';
export type { ModelRouterModelId, Provider, ModelForProvider, AttachmentCapabilities, } from './model/provider-registry.js';
