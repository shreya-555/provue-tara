...
var PromptBlocksStorage = class extends chunkZKUOABDW_cjs.VersionedStorageDomain {
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      blocks = blocks.filter((block) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkNLACGSDP_cjs.deepEqual(block.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-X63DZHAT.cjs.map
//# sourceMappingURL=chunk-X63DZHAT.cjs.map