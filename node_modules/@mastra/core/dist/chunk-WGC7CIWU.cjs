...
var MCPClientsStorage = class extends chunkZKUOABDW_cjs.VersionedStorageDomain {
  listKey = "mcpClients";
  ...
  async list(args) {
    ...
    if (metadata && Object.keys(metadata).length > 0) {
      configs = configs.filter((config) => {
        ...
        return Object.entries(metadata).every(([key, value]) => chunkNLACGSDP_cjs.deepEqual(config.metadata[key], value));
      });
    }
...
//# sourceMappingURL=chunk-WGC7CIWU.cjs.map
//# sourceMappingURL=chunk-WGC7CIWU.cjs.map