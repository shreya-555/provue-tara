...
var MastraGateway = class extends chunkJBYS3POB_cjs.MastraModelGateway {
  constructor(config) {
    super();
    this.config = config;
  }
  ...
  resolveLanguageModel({
    ...
    if (this.config?.customFetch && providerId === "anthropic") {
      return chunkJBYS3POB_cjs.createAnthropic({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunkJBYS3POB_cjs.MASTRA_USER_AGENT,
          [chunkJBYS3POB_cjs.GATEWAY_AUTH_HEADER]: `Bearer ${apiKey}`,
          ...headers
        },
    ...
    if (this.config?.customFetch) {
      return chunk7WVQHAW5_cjs.createOpenRouter({
        apiKey: "oauth-gateway-placeholder",
        baseURL,
        headers: {
          "User-Agent": chunkJBYS3POB_cjs.MASTRA_USER_AGENT,
...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-XKOQ7YF6.cjs', document.baseURI).href)) || "file://");
...
function loadRegistry(useDynamicLoading, customGateways = []) {
  const enabledGatewayIds = getEnabledGatewayIds([
    new chunk7WVQHAW5_cjs.ModelsDevGateway({}),
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway: ModelsDevGateway2 } = await import('./models-dev-NBWVMFOM.cjs');
      const { NetlifyGateway: NetlifyGateway2 } = await import('./netlify-3VNJBT65.cjs');
      const { MastraGateway: MastraGateway2 } = await import('./mastra-6NF5BRQO.cjs');
      const { fetchProvidersFromGateways, writeRegistryFiles } = await import('./registry-generator-QVMN4VCQ.cjs');
...
//# sourceMappingURL=chunk-XKOQ7YF6.cjs.map
//# sourceMappingURL=chunk-XKOQ7YF6.cjs.map