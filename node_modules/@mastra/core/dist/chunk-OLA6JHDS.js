import { MastraFGAPermissions } from './chunk-I6DU42VP.js';
import { wrapMastra, createObservabilityContext } from './chunk-56N5GIUY.js';
import { getOrCreateSpan, executeWithContext } from './chunk-J6GRNR3C.js';
import { EntityType } from './chunk-5EUPO3HH.js';
import { ToolStream, noopObserve } from './chunk-CKTH4DL7.js';
import { Tool, isVercelTool, isProviderDefinedTool, validateToolInput, getNeedsApprovalFn, validateToolOutput, validateToolSuspendData } from './chunk-LWKMPCC7.js';
...
import { backgroundOverrideZodSchema, backgroundOverrideJsonSchema } from './chunk-NHAYZXTF.js';
...
var CoreToolBuilder = class extends MastraBase {
  ...
  createExecute(tool, options, logType) {
    ...
    return async (args, execOptions) => {
      ...
      if (fgaProvider) {
        const { getAgentToolFGAResourceId, getMCPToolFGAResourceId, getStandaloneToolFGAResourceId, requireFGA } = await import('./fga-check-DVQTLYLA.js');
...
//# sourceMappingURL=chunk-OLA6JHDS.js.map
//# sourceMappingURL=chunk-OLA6JHDS.js.map