...
var MastraVoice = class extends chunkOXCC7WGI_cjs.MastraBase {
  listeningModel;
  speechModel;
  speaker;
  realtimeConfig;
...
var AISDKSpeech = class extends MastraVoice {
  ...
  async speak(input, options) {
    ...
    const result = await chunkFWVNVEOQ_cjs.generateSpeech({
      model: this.model,
      text,
...
var AISDKTranscription = class extends MastraVoice {
  ...
  async listen(audioStream, options) {
    ...
    const result = await chunkFWVNVEOQ_cjs.transcribe({
      model: this.model,
      audio: audioBuffer,
      providerOptions: options?.providerOptions,
      abortSignal: options?.abortSignal,
...
//# sourceMappingURL=chunk-TK4XTWP5.cjs.map
//# sourceMappingURL=chunk-TK4XTWP5.cjs.map